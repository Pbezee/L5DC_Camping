...
<body>
    ...
    <div class="policy">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to GWSC.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to GWSC, accessible from <a href="http://localhost/camping"
                        rel="external nofollow noopener" target="_blank">http://localhost/camping</a></p>
            </li>
            <li>
        ...
        <div class="personal-datause">
            ...
            <ul class="personal-datause-bottom">
        ...
        <ul>
            <li>
                <p>By email: gwsc@gmail.com</p>
            </li>
            <li>
                <p>By visiting this page on our website: <a href="http://localhost/camping/contactform.php"
                        rel="external nofollow noopener" target="_blank">http://localhost/camping/contactform.php</a>
                </p>
            </li>
        </ul>
    </div>
    ...
    document.getElementById('page-name').innerHTML = "You are at <b>Policy Page</b>";
    </script>
</body>
